...
//console.log("fixed_responsive_nav loaded");
(function () {
  ...
  if ("querySelector" in document && "addEventListener" in window) {
    ...
    var setupLocations = function () {
      ...
      forEach(links, function (i, el) {
		...
		//console.log (document.getElementById(href).offsetTop + 200);
      });
    };
	...
	console.log("Highlight active link on the navigation");
